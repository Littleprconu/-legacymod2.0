...
sheets:{'1sheet':'https://i.imgur.com/Y20s7b8_d.webp?maxwidth=760&amp;fidelity=grand'},//custom stylesheet (note : broken in IE and Edge for the time being),
func:function()
{
new G.Unit({
		name:'Pizza Maker',
		...
		gizmos:true,
		modes:{
    'cook':{name:'Cook',icon:[0,0,'1sheet'],desc:'Turn [seafood] and [herb]s into [Pizza].',req:{'Pizza Cooking':true}},
			},
		effects:[
